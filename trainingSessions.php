...
<a href="addt.php" class="btn btn-large btn-info" id="buttons"> &nbsp; Update</a>

<div id="content">
<form method="post" name="frmt">
<table>
<tr>
<td colspan=5 id="left" align:"center">Training Sessions</td>
</tr>
<tr>
<td id="left">
Title
...
<?php
	...
	$conn=openconn();
	$res = $conn->query("SELECT * FROM trainingsessions where id = 'abhay'");
	$count = $res->num_rows;
...
if($count > 0)
{
    ...
    <span><img src="edit.png" onClick="edit_recordst();" alt="edit" />edit</span> 
    <span><img src="delete.png" onClick="delete_recordst();" alt="delete" />delete</span>
    </label>
