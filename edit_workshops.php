...
#logout{right:30px;bottom:20px;width:30px;}
</style>
...
<a href="addw.php" class="btn btn-large btn-info" id="addrecords"> &nbsp; Add Records</a>
</div>
<div id="content">
<form method="post" action="updateworkshops.php">
<input type="hidden" name="username" value="<?php echo $username;?>">
<table class='table table-bordered'>
<tr>
<td colspan=4 id="left" align:"center">Workshops</td>
</tr>
<tr>
...
for($i=0; $i<$chkcount; $i++)
{
	...
	$res=$conn->query("SELECT * FROM workshops where sno = '$id'");
...
<a href="<?php echo $workshopslink?>" class=" btn btn-danger" style="float:right";> &nbsp; cancel</a>
</div>
</form>
<div id="result"></div>
</div>
