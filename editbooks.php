...
<a href="addb.php" class="btn btn-large btn-info" id="addrecord"> &nbsp; Add Records</a>
</div>
...
for($i=0; $i<$chkcount; $i++)
{
	...
	$res=$conn->query("SELECT * FROM books where isbn = '$id'");
	...
	while($row=$res->fetch_array())
	{
		...
		<td>
		<input type="text" name="isbn[]" value="<?php echo $row['isbn'];?>" class="form-control" readonly>
		</td>
        <td>
...
<a href="books.php" class=" btn btn-danger" style="float:right";> &nbsp; cancel</a>
</td>
</tr>
</table>
</form>
