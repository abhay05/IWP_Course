...
/*.p1{postion:relative;left:50%;top:2%;}*/
	...
	.container{position:absolute;
		top:20%;
		padding :2px;
		left:35%;max-height:60%;overflow:auto;}
		*{margin:0;}
...
<a href="adda.php" class="btn btn-large btn-info" id="addrecord"> &nbsp; Add Records</a>
</div>
<form method="post" action="updateawards.php">
<table class='table table-bordered'>
<tr>
<td colspan=4 id="left" align:"center">Awards</td>
</tr>
<tr>
...
for($i=0; $i<$chkcount; $i++)
{
	...
	$res=$conn->query("SELECT * FROM awards where sno = '$id'");
	...
	while($row=$res->fetch_array())
	{
		...
		<td>
		<input type="text" name="organisation[]" value="<?php echo $row['organisation'];?>" class="form-control" required>
		</td>
		<td>
...
<a href="awards.php" class=" btn btn-danger" style="float:right";> &nbsp; cancel</a>
</td>
</tr>
</table>
</form>
