...
{		
	...
	for($i=1; $i<=$total; $i++)
	{
		...
		$sql="INSERT INTO trainingsessions(id,title,role,date,description) VALUES('abhay','".$title."','".$role."','".$date."','".$description."')";
		$sql = $conn->query($sql);		
	}
...
<a href="addt.php" class="btn btn-large btn-info" id="back">&nbsp; Add Records</a>
</div>
<?php
if(isset($_POST['btn-gen-form']))
{
    ...
    <a href="trainingSessions.php" class="btn btn-large btn-success" id="backn"> &nbsp; Back to index</a>
